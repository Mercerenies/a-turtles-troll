...
object EggGravestoneSpawner : GravestoneSpawner() {
  ...
  override fun spawnGravestone(centerBlock: Block, inscriptions: Inscriptions, rotation: Rotation) {
    ...
    replaceWithStair(centerBlock.location.clone().add(rotation.vector(0, 0, 1)).block, Bisected.Half.TOP, BlockFace.NORTH)
    ...
    replaceWithStair(centerBlock.location.clone().add(rotation.vector(0, 0, -1)).block, Bisected.Half.TOP, BlockFace.SOUTH)
