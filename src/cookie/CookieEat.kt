...
object CookieEat {
  ...
  fun defaultEffects(plugin: Plugin) = listOf(
    ...
    Weight(ApplyPotionEffect("Damage Resistance", PotionEffectType.RESISTANCE), 0.031),
    Weight(ApplyPotionEffect("Dolphins Grace", PotionEffectType.DOLPHINS_GRACE), 0.031),
    Weight(ApplyPotionEffect("Haste", PotionEffectType.HASTE), 0.031),
    Weight(ApplyPotionEffect("Fire Resistance", PotionEffectType.FIRE_RESISTANCE), 0.031),
    Weight(ApplyPotionEffect("Instant Health", PotionEffectType.INSTANT_HEALTH), 0.031),
    ...
    Weight(ApplyPotionEffect("Strength", PotionEffectType.STRENGTH), 0.031),
    Weight(ApplyPotionEffect("Invisibility", PotionEffectType.INVISIBILITY), 0.031),
    Weight(ApplyPotionEffect("Jump Boost", PotionEffectType.JUMP_BOOST), 0.031),
    ...
    Weight(ApplyPotionEffect("Nausea", PotionEffectType.NAUSEA), 0.031),
    Weight(ApplyPotionEffect("Instant Damage", PotionEffectType.INSTANT_DAMAGE), 0.031),
    ...
    Weight(ApplyPotionEffect("Slowness", PotionEffectType.SLOWNESS), 0.031),
    Weight(ApplyPotionEffect("Mining Fatigue", PotionEffectType.MINING_FATIGUE), 0.031),
