...
class Main : JavaPlugin() {
  ...
  val blazeListener = BlazeAttackListener(this)
  ...
  override fun onEnable() {
    ...
    Bukkit.getPluginManager().registerEvents(snowListener, this)
    ...
    Bukkit.getPluginManager().registerEvents(blazeListener, this)
